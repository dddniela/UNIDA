...
<section class="seccion-contenedor">
        ...
        <div class="seccion-texto">
            ...
            <li class="seccion-texto-lista-item">Dra. Cynthia Cano Sarmiento</li>
...
<section class="seccion-contenedor">
        ...
        <div class="seccion-texto">
            ...
            <div class="seccion-lista-item">
                <h5 class="seccion-lista-parrafo">Texturómetro</h5>
            </div>

            <div class="seccion-lista-item">
                <h5 class="seccion-lista-parrafo">Fluidos supercríticos</h5>
            </div>

            <h3 class="seccion-texto-subtitulo">Servicios Especializados</h3>
            <div class="seccion-lista-item">
                <h5 class="seccion-lista-parrafo">Análisis fisicoquímicos</h5>
            </div>

            <div class="seccion-lista-item">
                <h5 class="seccion-lista-parrafo">Análisis de textura de alimentos</h5>
            </div>
    ...
    <div class="seccion-galeria">
        <img class="seccion-imagen" src="img/laboratorios/fisico-quimica/IMG_7427.jpg" alt="">
        <img class="seccion-imagen" src="img/laboratorios/fisico-quimica/IMG_7432.jpg" alt="">
        <img class="seccion-imagen" src="img/laboratorios/fisico-quimica/IMG_7433.jpg" alt="">
