...
<section class="seccion-contenedor modoOscuro">
    ...
    <div class="seccion-texto">
        ...
        <li class="seccion-texto-lista-item">Una vez que haya sido aceptado en el programa deberá pasar a la Coordinación de Posgrado por su número de matrícula y carga académica.</li>
